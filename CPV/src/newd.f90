...
!
!-------------------------------------------------------------------------
   SUBROUTINE newd(vr,irb,eigrb,rhovan,fion,tprint)
!-----------------------------------------------------------------------
!
...
!$omp          shared(ngb, nh, qgb, eigrb, dfftb, irb, vr, ci, deeq, tfor, thdyn, tprnfor, tprint, &
!$omp                 fac, nspin, my_bgrp_id, nbgrp, ityp, upf, nat, fvan, tpibab, gxb, rhovan ) &
!$omp          private(mytid, ntids, is, ia, nfft, iv, jv, ijv, ig, qv, fg1, fg2, itid, res, &
